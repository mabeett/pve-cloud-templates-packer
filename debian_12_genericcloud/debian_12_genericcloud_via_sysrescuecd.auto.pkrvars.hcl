...
# cloud_img_url   = "http://192.168.0.21/cloud-images/debian-12-genericcloud-amd64.qcow2"
cloud_init_user = "debian"

# VM description
vm_name              = "debian-12-genericcloudimg-template-WIP"
template_name        = "debian-12-genericcloudimg"
template_description = "Debian 12 small via packer"
vm_id                = 1000014
