...
# VM description
vm_name              = "ubuntu-2604-cloudimg-template-WIP"
template_name        = "ubuntu-2604-cloudimg"
template_description = "Ubuntu 26.04 LTS (Resolute Raccoon) via packer\n\n[info](https://cloud-images.ubuntu.com/resolute/current/)"
vm_id                = 1000022
