...
# OS
# cloud_img_url = "http://192.168.0.21/cloud-images/debian-13-generic-amd64.qcow2"
cloud_img_url   = "https://cloud.debian.org/images/cloud/trixie/latest/debian-13-generic-amd64.qcow2"
cloud_init_user = "debian"

# VM description
vm_name              = "debian-13-cloudimg-template-WIP"
template_name        = "debian-13-cloudimg"
template_description = "Debian 13 via packer"
vm_id                = 1000019
